...
export const ALL_GRADES: number[] = [3, 4, 5, 6, 7, 8]
...
export const levelInfo: BloomLevelType[] = [
  ...
  },
  {
    ...
    name: 'Comprehension',
    definition:
      'The ability to explain ideas or concepts, grasp meaning, and interpret information.',
  ...
  },
  {
    ...
    name: 'Evaluation',
    definition:
      'Making judgments based on criteria and standards through checking and critiquing. This is the highest level of thinking in the original taxonomy.',
